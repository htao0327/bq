        ...
        PopActionClickListener popActionClickListener = new PopActionClickListener() {
            ...
            public void onActionClick(int position, Object data) {
                ...
                if (TextUtils.equals(action.getActionName(), mActivity.getResources().getString(R.string.add_friend))) {
                    Intent intent = new Intent(MyApplication.instance(), AddMoreActivity.class);//添加好友
                ...
                if (TextUtils.equals(action.getActionName(), mActivity.getResources().getString(R.string.add_group))) {
                    Intent intent = new Intent(MyApplication.instance(), AddMoreActivity.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
...
//                    Intent intent = new Intent(MyApplication.instance(), StartC2CChatActivity.class);
//                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//                    mActivity.startActivity(intent);
//                }
...
//
        ...
        action = new PopMenuAction();
        action.setActionName(mActivity.getResources().getString(R.string.create_new_group));
        action.setIconResId(R.drawable.m_group_icon);
        action.setActionClickListener(popActionClickListener);
        menuActions.add(action);
        ...
        action.setIconResId(R.drawable.sys_1);
        action.setActionClickListener(popActionClickListener);
        menuActions.add(action);

        action = new PopMenuAction();
        action.setActionName(mActivity.getResources().getString(R.string.txl));
        action.setIconResId(R.drawable.txl_1);
        action.setActionClickListener(popActionClickListener);
        menuActions.add(action);
...
//        backgroundAlpha(0.5f);
        // 相对于 + 号正下面，同时可以设置偏移量
        mMenuWindow.showAtLocation(mAttachView, Gravity.RIGHT | Gravity.TOP, ScreenUtil.getPxByDp(5), ScreenUtil.getPxByDp(60));
        // 设置pop关闭监听，用于改变背景透明度
