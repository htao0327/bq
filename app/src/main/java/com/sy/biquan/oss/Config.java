...
public class Config {
    ...
    public static final String STS_SERVER_URL = "https://landscape-test.oss-cn-hangzhou.aliyuncs.com";//STS 地址

    public static final String BUCKET_NAME = "landscape-test";
    public static final String OSS_ACCESS_KEY_ID = "LTAI4FuYVSZUTu9EkmNVdBbf";
    public static final String OSS_ACCESS_KEY_SECRET = "Lo9ZihFQiWhnp5tlRnJQtN8cUqGpT8";
