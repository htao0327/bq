...
//        ll_xc = findViewById(R.id.ll_xc);//相册
//        ll_ps = findViewById(R.id.ll_ps);//拍摄
//        ll_wj = findViewById(R.id.ll_wj);//文件
//        ll_ds = findViewById(R.id.ll_ds);//打赏
//        ll_sp = findViewById(R.id.ll_sp);//视频
//        ll_transaction = findViewById(R.id.ll_transaction);//发起交易
        // 子类实现所有的事件处理
        init();
    }
...
//        ll_xc.setOnClickListener(new OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                startSendPhoto();
//            }
//        });
//        ll_ps.setOnClickListener(new OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                startCapture();
//            }
...
//            }
//        });
//        ll_wj.setOnClickListener(new OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                startSendFile();
//            }
//        });
        ...
        if (!mSendPhotoDisable) {
            action.setIconResId(R.drawable.zhaopian);
        ...
        if (!mCaptureDisable) {
            ...
            action.setIconResId(R.drawable.img_shape);
        ...
        if (!mVideoRecordDisable) {
            action = new InputMoreActionUnit();
            action.setIconResId(R.drawable.shipin);
        ...
        if (!mSendFileDisable) {
            action = new InputMoreActionUnit();
            action.setIconResId(R.drawable.wenjian);
